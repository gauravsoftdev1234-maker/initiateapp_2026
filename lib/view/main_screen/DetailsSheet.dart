...
String cleanUrl(String url) {
  // Removes brackets [ ] and extra quotes " if present in the string
  return url.replaceAll('[', '').replaceAll(']', '').replaceAll('"', '').trim();
}
...
//   const DetailsSheet({super.key, required this.user});
//
//   @override
//   Widget build(BuildContext context) {
//     return Container(
...
//                 ),
//               ),
//               const Icon(Iconsax.verify_copy, color: Colors.blue),
//             ],
//           ),
//           const SizedBox(height: 10),
//           _detailRow(Iconsax.location_copy, user.city),
//           _detailRow(Iconsax.teacher_copy, user.jobTitle),
//           _detailRow(Iconsax.bank_copy, user.university),
...
//                 borderRadius: BorderRadius.circular(15),
//                 child: Image.network(cleanUrl(user.galleryImages[i]), fit: BoxFit.cover),
//               ),
//             ),
//           ],
//         ],
